...
const Logo: React.FC<LogoProps> = ({ size = 40, className = "" }) => {
  return (
    ...
    >
      ...
      />
      <div className="absolute inset-1 rounded-full bg-gradient-to-br from-mono-gray-100 to-mono-gray-400 overflow-hidden flex items-center justify-center border border-mono-gray-300">
