          ...
          <div className="container mx-auto">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-white/70 mb-10 max-w-2xl mx-auto">
                Own a piece of the future of telecommunications through
                fractional NFT ownership. Earn passive income and participate in
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-ana-darkblue/40 backdrop-blur-sm p-6 rounded-lg border border-ana-purple/20">
                ...
                <p className="text-white/70">
                  Own shares of AirNodes as NFTs and receive passive income
              ...
              <div className="bg-ana-darkblue/40 backdrop-blur-sm p-6 rounded-lg border border-ana-purple/20">
                ...
                <p className="text-white/70">
                  ...
                  World Mobile Chain (WMC) blockchain.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto max-w-4xl">
            <div className="text-center">
              ...
              <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
                Sign up now to get notified about upcoming AirNode drops and
                start your journey into decentralized telecommunications
                ownership.
              </p>
